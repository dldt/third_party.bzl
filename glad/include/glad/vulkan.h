/**
 * Loader generated by glad 2.0.0-beta on Tue Mar  3 18:55:30 2020
 *
 * Generator: C/C++
 * Specification: vk
 * Extensions: 2
 ...
 *
 * Commandline:
 *    --api='vulkan=1.2' --extensions='VK_KHR_surface,VK_KHR_swapchain' c
 * --mx-global --loader --mx
 *
 * Online:
 *    http://glad.sh/#api=vulkan%3D1.2&extensions=VK_KHR_surface%2CVK_KHR_swapchain&generator=c&options=MX_GLOBAL%2CLOADER%2CMX
 *
 */
...
#define VK_API_VERSION_1_2 \
  VK_MAKE_VERSION(1, 2, 0) /* Patch version should always be set to 0 */
...
#define vkCmdClearDepthStencilImage \
  (glad_vulkan_context.CmdClearDepthStencilImage)
...
#define vkCmdDrawIndexedIndirectCount \
  (glad_vulkan_context.CmdDrawIndexedIndirectCount)
...
#define vkCmdSetStencilCompareMask \
  (glad_vulkan_context.CmdSetStencilCompareMask)
...
#define vkCreateDescriptorSetLayout \
  (glad_vulkan_context.CreateDescriptorSetLayout)
#define vkCreateDescriptorUpdateTemplate \
  (glad_vulkan_context.CreateDescriptorUpdateTemplate)
...
#define vkCreateSamplerYcbcrConversion \
  (glad_vulkan_context.CreateSamplerYcbcrConversion)
...
#define vkDestroyDescriptorSetLayout \
  (glad_vulkan_context.DestroyDescriptorSetLayout)
#define vkDestroyDescriptorUpdateTemplate \
  (glad_vulkan_context.DestroyDescriptorUpdateTemplate)
...
#define vkDestroySamplerYcbcrConversion \
  (glad_vulkan_context.DestroySamplerYcbcrConversion)
...
#define vkEnumerateDeviceExtensionProperties \
  (glad_vulkan_context.EnumerateDeviceExtensionProperties)
#define vkEnumerateDeviceLayerProperties \
  (glad_vulkan_context.EnumerateDeviceLayerProperties)
#define vkEnumerateInstanceExtensionProperties \
  (glad_vulkan_context.EnumerateInstanceExtensionProperties)
#define vkEnumerateInstanceLayerProperties \
  (glad_vulkan_context.EnumerateInstanceLayerProperties)
#define vkEnumerateInstanceVersion \
  (glad_vulkan_context.EnumerateInstanceVersion)
#define vkEnumeratePhysicalDeviceGroups \
  (glad_vulkan_context.EnumeratePhysicalDeviceGroups)
#define vkEnumeratePhysicalDevices \
  (glad_vulkan_context.EnumeratePhysicalDevices)
...
#define vkGetBufferMemoryRequirements \
  (glad_vulkan_context.GetBufferMemoryRequirements)
#define vkGetBufferMemoryRequirements2 \
  (glad_vulkan_context.GetBufferMemoryRequirements2)
#define vkGetBufferOpaqueCaptureAddress \
  (glad_vulkan_context.GetBufferOpaqueCaptureAddress)
#define vkGetDescriptorSetLayoutSupport \
  (glad_vulkan_context.GetDescriptorSetLayoutSupport)
#define vkGetDeviceGroupPeerMemoryFeatures \
  (glad_vulkan_context.GetDeviceGroupPeerMemoryFeatures)
#define vkGetDeviceGroupPresentCapabilitiesKHR \
  (glad_vulkan_context.GetDeviceGroupPresentCapabilitiesKHR)
#define vkGetDeviceGroupSurfacePresentModesKHR \
  (glad_vulkan_context.GetDeviceGroupSurfacePresentModesKHR)
#define vkGetDeviceMemoryCommitment \
  (glad_vulkan_context.GetDeviceMemoryCommitment)
#define vkGetDeviceMemoryOpaqueCaptureAddress \
  (glad_vulkan_context.GetDeviceMemoryOpaqueCaptureAddress)
...
#define vkGetImageMemoryRequirements \
  (glad_vulkan_context.GetImageMemoryRequirements)
#define vkGetImageMemoryRequirements2 \
  (glad_vulkan_context.GetImageMemoryRequirements2)
#define vkGetImageSparseMemoryRequirements \
  (glad_vulkan_context.GetImageSparseMemoryRequirements)
#define vkGetImageSparseMemoryRequirements2 \
  (glad_vulkan_context.GetImageSparseMemoryRequirements2)
#define vkGetImageSubresourceLayout \
  (glad_vulkan_context.GetImageSubresourceLayout)
#define vkGetInstanceProcAddr (glad_vulkan_context.GetInstanceProcAddr)
#define vkGetPhysicalDeviceExternalBufferProperties \
  (glad_vulkan_context.GetPhysicalDeviceExternalBufferProperties)
#define vkGetPhysicalDeviceExternalFenceProperties \
  (glad_vulkan_context.GetPhysicalDeviceExternalFenceProperties)
#define vkGetPhysicalDeviceExternalSemaphoreProperties \
  (glad_vulkan_context.GetPhysicalDeviceExternalSemaphoreProperties)
#define vkGetPhysicalDeviceFeatures \
  (glad_vulkan_context.GetPhysicalDeviceFeatures)
#define vkGetPhysicalDeviceFeatures2 \
  (glad_vulkan_context.GetPhysicalDeviceFeatures2)
#define vkGetPhysicalDeviceFormatProperties \
  (glad_vulkan_context.GetPhysicalDeviceFormatProperties)
#define vkGetPhysicalDeviceFormatProperties2 \
  (glad_vulkan_context.GetPhysicalDeviceFormatProperties2)
#define vkGetPhysicalDeviceImageFormatProperties \
  (glad_vulkan_context.GetPhysicalDeviceImageFormatProperties)
#define vkGetPhysicalDeviceImageFormatProperties2 \
  (glad_vulkan_context.GetPhysicalDeviceImageFormatProperties2)
#define vkGetPhysicalDeviceMemoryProperties \
  (glad_vulkan_context.GetPhysicalDeviceMemoryProperties)
#define vkGetPhysicalDeviceMemoryProperties2 \
  (glad_vulkan_context.GetPhysicalDeviceMemoryProperties2)
#define vkGetPhysicalDevicePresentRectanglesKHR \
  (glad_vulkan_context.GetPhysicalDevicePresentRectanglesKHR)
#define vkGetPhysicalDeviceProperties \
  (glad_vulkan_context.GetPhysicalDeviceProperties)
#define vkGetPhysicalDeviceProperties2 \
  (glad_vulkan_context.GetPhysicalDeviceProperties2)
#define vkGetPhysicalDeviceQueueFamilyProperties \
  (glad_vulkan_context.GetPhysicalDeviceQueueFamilyProperties)
#define vkGetPhysicalDeviceQueueFamilyProperties2 \
  (glad_vulkan_context.GetPhysicalDeviceQueueFamilyProperties2)
#define vkGetPhysicalDeviceSparseImageFormatProperties \
  (glad_vulkan_context.GetPhysicalDeviceSparseImageFormatProperties)
#define vkGetPhysicalDeviceSparseImageFormatProperties2 \
  (glad_vulkan_context.GetPhysicalDeviceSparseImageFormatProperties2)
#define vkGetPhysicalDeviceSurfaceCapabilitiesKHR \
  (glad_vulkan_context.GetPhysicalDeviceSurfaceCapabilitiesKHR)
#define vkGetPhysicalDeviceSurfaceFormatsKHR \
  (glad_vulkan_context.GetPhysicalDeviceSurfaceFormatsKHR)
#define vkGetPhysicalDeviceSurfacePresentModesKHR \
  (glad_vulkan_context.GetPhysicalDeviceSurfacePresentModesKHR)
#define vkGetPhysicalDeviceSurfaceSupportKHR \
  (glad_vulkan_context.GetPhysicalDeviceSurfaceSupportKHR)
...
#define vkUpdateDescriptorSetWithTemplate \
  (glad_vulkan_context.UpdateDescriptorSetWithTemplate)
...
GLAD_API_CALL int gladLoadVulkanContextUserPtr(GladVulkanContext *context,
                                               VkPhysicalDevice physical_device,
                                               GLADuserptrloadfunc load,
                                               void *userptr);
GLAD_API_CALL int gladLoadVulkanContext(GladVulkanContext *context,
                                        VkPhysicalDevice physical_device,
                                        GLADloadfunc load);
...
GLAD_API_CALL int gladLoaderLoadVulkanContext(GladVulkanContext *context,
                                              VkInstance instance,
                                              VkPhysicalDevice physical_device,
                                              VkDevice device);
