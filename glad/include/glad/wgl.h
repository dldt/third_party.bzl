/**
 * Loader generated by glad 2.0.0-beta on Tue Mar  3 17:33:30 2020
 *
 * Generator: C/C++
 * Specification: wgl
 * Extensions: 2
...
typedef int(GLAD_API_PTR *PFNDESCRIBEPIXELFORMATPROC)(
    HDC hdc, int ipfd, UINT cjpfd, const PIXELFORMATDESCRIPTOR *ppfd);
typedef UINT(GLAD_API_PTR *PFNGETENHMETAFILEPIXELFORMATPROC)(
    HENHMETAFILE hemf, const PIXELFORMATDESCRIPTOR *ppfd);
