...
static void glad_glx_load_GLX_VERSION_1_1(GLADuserptrloadfunc load,
  ...
  glad_glXQueryExtensionsString = (PFNGLXQUERYEXTENSIONSSTRINGPROC)load(
...
static void glad_glx_load_GLX_VERSION_1_3(GLADuserptrloadfunc load,
  ...
  glad_glXGetCurrentReadDrawable = (PFNGLXGETCURRENTREADDRAWABLEPROC)load(
  ...
  glad_glXGetVisualFromFBConfig = (PFNGLXGETVISUALFROMFBCONFIGPROC)load(
...
static int glad_glx_has_extension(Display *display, int screen,
                                  const char *ext) {
...
int gladLoadGLXUserPtr(Display *display, int screen, GLADuserptrloadfunc load,
                       void *userptr) {
  int version;
...
int gladLoaderLoadGLX(Display *display, int screen) {
  ...
  if (handle != NULL) {
    ...
    if (loader != NULL) {
      version = gladLoadGLXUserPtr(display, screen, glad_glx_get_proc,
                                   GLAD_GNUC_EXTENSION(void *) loader);
    }
